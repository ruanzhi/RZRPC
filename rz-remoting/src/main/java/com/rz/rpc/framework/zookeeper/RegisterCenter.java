...
public class RegisterCenter implements IRegisterCenter4Invoker, IRegisterCenter4Provider, IRegisterCenter4Governance {
    ...
    @Override
    public void registerProvider(List<ProviderService> providerServiceList) {
        ...
        synchronized (RegisterCenter.class) {
            ...
            //创建路径： ZK命名空间/当前部署应用APP命名空间/
            String APP_KEY = providerServiceList.get(0).getAppKey();
